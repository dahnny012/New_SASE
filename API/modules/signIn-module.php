<?php     
    ...
    class SignIn_Model extends Model{
        ...
        public function insertPrograms($post){
            $logs = [];
            $logs["tech"] = fopen($this->docRoot()."/SignIn/logs/tech.txt","a");
            $logs["volunteer"] = fopen($this->docRoot()."/SignIn/logs/volunteer.txt","a");
            $logs["mentor"] = fopen($this->docRoot()."/SignIn/logs/mentor.txt","a");
